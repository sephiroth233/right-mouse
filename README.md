...
启动存储修复的历史验证见 [启动存储记录](Config/validation/development-storage-fallback-2026-09-23.md)；最新构建的检查结果与校验值见[剪切与协议验证](specs/001-finder-core/evidence/EV-clipboard-protocol-001.md)。
