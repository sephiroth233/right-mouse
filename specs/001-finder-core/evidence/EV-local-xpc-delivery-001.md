...
已更新同路径 DMG，`hdiutil verify` 和 SHA-256 校验通过；当前镜像 SHA-256 为 `a0cd1d250922748f434f40374f4340f4492fb80eaf1bdca82a4e08280d6894a4`。本次构建证书指纹为 `25351add9490eebc563e871e9de5243891f7640b`，此前构建的检查记录保留为历史证据。
